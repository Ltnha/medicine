...
<body>
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php if (empty($thuoc_list)): ?>
                                    <tr>
                                        <td colspan="6" class="text-center py-10 text-gray-400">Không tìm thấy loại thuốc nào phù hợp.</td>
                                    </tr>
                                <?php else: ?>
    ...
    <div id="modalDetailThuoc" class="fixed inset-0 z-50 flex items-center justify-center hidden">
        ...
        <div class="relative w-full max-w-lg p-6 bg-white shadow-2xl rounded-2xl z-10 mx-4 max-h-[90vh] overflow-y-auto" style="box-shadow: var(--shadow-modal);">
            ...
            <div class="space-y-3">
                <div><span class="block text-xs font-bold text-gray-400 uppercase">Tên thuốc</span>
                    <div id="det_ten_thuoc" class="text-base font-semibold bg-gray-50 px-3 py-2 rounded-lg border">--</div>
                </div>
                <div><span class="block text-xs font-bold text-gray-400 uppercase">Danh mục</span>
                    <div id="det_danh_muc" class="text-sm bg-gray-50 px-3 py-2 rounded-lg border">--</div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div><span class="block text-xs font-bold text-gray-400 uppercase">Hàm lượng</span>
                        <div id="det_ham_luong" class="text-sm bg-gray-50 px-3 py-2 rounded-lg border">--</div>
                    </div>
                    <div><span class="block text-xs font-bold text-gray-400 uppercase">Giá bán</span>
                        <div id="det_gia_ban" class="text-sm font-semibold text-emerald-700 bg-gray-50 px-3 py-2 rounded-lg border">--</div>
                    </div>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div><span class="block text-xs font-bold text-gray-400 uppercase">Dạng bào chế</span>
                        <div id="det_dang_bao_che" class="text-sm bg-gray-50 px-3 py-2 rounded-lg border">--</div>
                    </div>
                    <div><span class="block text-xs font-bold text-gray-400 uppercase">Đơn vị tính</span>
                        <div id="det_don_vi_tinh" class="text-sm bg-gray-50 px-3 py-2 rounded-lg border">--</div>
                    </div>
                </div>
                <div><span class="block text-xs font-bold text-gray-400 uppercase">Yêu cầu đơn thuốc</span>
                    <div id="det_yeu_cau" class="pt-1">--</div>
                </div>
                <div><span class="block text-xs font-bold text-gray-400 uppercase">Thành phần</span>
                    <div id="det_thanh_phan" class="text-sm bg-gray-50 px-3 py-2 rounded-lg border border-gray-100 whitespace-pre-line">--</div>
                </div>
                <div><span class="block text-xs font-bold text-gray-400 uppercase">Công dụng</span>
                    <div id="det_cong_dung" class="text-sm bg-gray-50 px-3 py-2 rounded-lg border border-gray-100 whitespace-pre-line">--</div>
                </div>
            </div>
